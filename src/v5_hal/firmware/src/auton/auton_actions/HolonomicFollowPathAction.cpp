...
HolonomicFollowPathAction::HolonomicFollowPathAction(IDriveNode* drive_node, OdometryNode* odom_node, Path path, bool reset_pose) :
...
void HolonomicFollowPathAction::ActionInit() {
    if (m_reset_pose) {
...
AutonAction::actionStatus HolonomicFollowPathAction::Action() {
...
void HolonomicFollowPathAction::ActionEnd() {
