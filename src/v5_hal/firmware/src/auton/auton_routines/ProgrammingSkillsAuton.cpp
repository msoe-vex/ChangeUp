...
void ProgrammingSkillsAuton::AddNodes() {
    ...
    AutonNode* path_deployWall2ToGoal4 = new AutonNode(1.75, new HolonomicFollowPathAction(m_drive_node, m_odom_node, PathManager::GetInstance()->GetPath("DeployWall2ToGoal4"), true));
    ...
    AutonNode* path_goal4ToGoal1 = new AutonNode(6.0, new HolonomicFollowPathAction(m_drive_node, m_odom_node, PathManager::GetInstance()->GetPath("V2-Goal4ToGoal1")));
    ...
    AutonNode* path_goal1ToGoal2 = new AutonNode(6.5, new HolonomicFollowPathAction(m_drive_node, m_odom_node, PathManager::GetInstance()->GetPath("V2-Goal1ToGoal2")));
    ...
    AutonNode* path_goal2ToGoal3 = new AutonNode(6.0, new HolonomicFollowPathAction(m_drive_node, m_odom_node, PathManager::GetInstance()->GetPath("V2-Goal2ToGoal3")));
    ...
    AutonNode* path_goal3ToGoal6 = new AutonNode(5.0, new HolonomicFollowPathAction(m_drive_node, m_odom_node, PathManager::GetInstance()->GetPath("V2-Goal3ToGoal6"), true));
    ...
    AutonNode* path_goal6ToGoal9 = new AutonNode(5.0, new HolonomicFollowPathAction(m_drive_node, m_odom_node, PathManager::GetInstance()->GetPath("V2-Goal6ToGoal9"), true));
    ...
    AutonNode* path_goal9ToGoal8 = new AutonNode(6.0, new HolonomicFollowPathAction(m_drive_node, m_odom_node, PathManager::GetInstance()->GetPath("V2-Goal9ToGoal8"), true));
    ...
    AutonNode* path_goal8ToGoal7 = new AutonNode(5.5, new HolonomicFollowPathAction(m_drive_node, m_odom_node, PathManager::GetInstance()->GetPath("V2-Goal8ToGoal7"), true));
    ...
    AutonNode* path_goal7ToGoal5 = new AutonNode(3.5, new HolonomicFollowPathAction(m_drive_node, m_odom_node, PathManager::GetInstance()->GetPath("V2-Goal7ToGoal5"), true));
    ...
    AutonNode* backAwayAndPrayToGod = new AutonNode(7.0, new HolonomicFollowPathAction(m_drive_node, m_odom_node, PathManager::GetInstance()->GetPath("V2-BackUp")));
