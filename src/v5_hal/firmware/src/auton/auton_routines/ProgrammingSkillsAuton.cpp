...
void ProgrammingSkillsAuton::AddNodes() {
    ...
    AutonNode* path_goal2ToGoal3 = new AutonNode(6.5, new FollowPathAction(m_drive_node, m_odom_node, PathManager::GetInstance()->GetPath("V2-Goal2ToGoal3")));
    ...
    AutonNode* path_goal3ToGoal6 = new AutonNode(6.0, new FollowPathAction(m_drive_node, m_odom_node, PathManager::GetInstance()->GetPath("V2-Goal3ToGoal6"), true));
    ...
    AutonNode* path_goal6ToGoal9 = new AutonNode(7.0, new FollowPathAction(m_drive_node, m_odom_node, PathManager::GetInstance()->GetPath("V2-Goal6ToGoal9")));
    ...
    AutonNode* path_goal9ToGoal8 = new AutonNode(7.0, new FollowPathAction(m_drive_node, m_odom_node, PathManager::GetInstance()->GetPath("V2-Goal9ToGoal8")));
    descoreGoal9->AddNext(path_goal9ToGoal8);

    addActionsToPath_Goal9ToGoal8(descoreGoal9, m_intake_node, m_conveyor_node);

    AutonNode* descoreGoal8 = getSingleGoalScoringSequence(path_goal9ToGoal8, m_intake_node, m_conveyor_node);

    AutonNode* path_goal8ToGoal7 = new AutonNode(7.0, new FollowPathAction(m_drive_node, m_odom_node, PathManager::GetInstance()->GetPath("V2-Goal8ToGoal7")));
    ...
    AutonNode* path_goal7ToGoal5 = new AutonNode(7.0, new FollowPathAction(m_drive_node, m_odom_node, PathManager::GetInstance()->GetPath("V2-Goal8ToGoal5")));
    descoreGoal7->AddNext(path_goal7ToGoal5);

    addActionsToPath_Goal7ToGoal5(descoreGoal7, m_intake_node, m_conveyor_node);

    AutonNode* descoreGoal5 = getDoubleGoalScoringSequence(path_goal7ToGoal5, m_intake_node, m_conveyor_node);
