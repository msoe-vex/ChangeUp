...
void ProgrammingSkillsAuton::AddNodes() {
    ...
    AutonNode* path_deployWall2ToGoal4 = new AutonNode(2.0, new FollowPathAction(m_drive_node, m_odom_node, PathManager::GetInstance()->GetPath("DeployWall2ToGoal4"), true));
