...
void ProgrammingSkillsAuton::AddNodes() {
    ...
    m_turn_1 = new AutonNode(5, new TurnToAngleAction(m_drive_node, m_inertial_sensor_node, Rotation2Dd(1.)));
    ...
    m_forward_1 = new AutonNode(5, new DriveAction(m_drive_node, 46, 49.1, 40));
    ...
    m_reverse_1 = new AutonNode(3, new DriveAction(m_drive_node, -14, 49.1, 40));

    m_wait_1->AddNext(m_reverse_1);

    m_turn_2 = new AutonNode(3, new TurnToAngleAction(m_drive_node, m_inertial_sensor_node, Rotation2Dd(3.2 * M_PI_4)));
    m_turn_2->AddAction(new IntakeAction(m_conveyor_node, 0));
    m_reverse_1->AddNext(m_turn_2);

    // Move toward corner goal
    m_forward_3 = new AutonNode(2, new DriveAction(m_drive_node, 22, 150, 40));
    ...
    m_reverse_2 = new AutonNode(2, new DriveAction(m_drive_node, -31, 150, 40));
    ...
    m_turn_3 = new AutonNode(1.5, new TurnToAngleAction(m_drive_node, m_inertial_sensor_node, Rotation2Dd(-0.9)));
    m_outtake_1->AddNext(m_turn_3);

    m_forward_4 = new AutonNode(3, new DriveAction(m_drive_node, 37.8, 200, 40));
    ...
    m_turn_4 = new AutonNode(1.5, new TurnToAngleAction(m_drive_node, m_inertial_sensor_node, Rotation2Dd(2.9)));
    m_forward_4->AddNext(m_turn_4);

    m_forward_5 = new AutonNode(2, new DriveAction(m_drive_node, 33, 150, 40));
    ...
    m_reverse_3 = new AutonNode(1.5, new DriveAction(m_drive_node, -9, 150, 40));
    ...
    m_turn_5 = new AutonNode(1, new TurnToAngleAction(m_drive_node, m_inertial_sensor_node, Rotation2Dd(-1.3)));
    ...
    m_forward_6 = new AutonNode(2.5, new DriveAction(m_drive_node, 28, 150, 40));
    ...
    m_forward_7 = new AutonNode(1, new DriveAction(m_drive_node, 8, 150, 40));
    m_capture_ball_1->AddNext(m_forward_7);

    m_turn_6 = new AutonNode(1, new TurnToAngleAction(m_drive_node, m_inertial_sensor_node, Rotation2Dd(-2.35)));
    m_turn_6->AddAction(new BottomConveyorAction(m_conveyor_node, false, 0));

    m_forward_7->AddNext(m_turn_6);

    m_forward_8 = new AutonNode(1.5, new DriveAction(m_drive_node, 24, 150, 40));
    ...
    m_forward_9 = new AutonNode(1.5, new DriveAction(m_drive_node, -14, 150, 40));
